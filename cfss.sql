...
--
-- Dumping data for table `main_files`
--

-- INSERT INTO `main_files` (`id`, `file_title`, `file_size`, `upload_date`, `file_link`, `file_starred`, `user_id`, `file_hidden`, `folder_id`) VALUES
...
-- INSERT INTO `main_folder` (`id`, `folder_name`, `folder_date`, `folder_starred`, `folder_link`, `parent_id`, `user_id`) VALUES
...
--
-- Table structure for table `main_shared`
--

CREATE TABLE `main_shared` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `main_shared`
--

-- INSERT INTO `main_shared` (`id`, `file`, `sharedUser_id`, `user_id`) VALUES
-- (1, 2, 13, 1), (5, 2, 13, 1), (8, 27, 1, 13);
...
-- INSERT INTO `main_user` (`id`, `email_addr`, `pswd`) VALUES
...
-- (9, 'auth', '0003_alter_email_addr_max_length', '2020-03-11 07:37:45.290104'),
...
--
-- Indexes for table `main_files`
--
ALTER TABLE `main_files`
  ADD PRIMARY KEY (`id`),
  ADD KEY `main_files_user_id_fbc7dfc0_fk_main_user_id` (`user_id`),
...
--
-- Indexes for table `main_shared`
--
ALTER TABLE `main_shared`
  ADD PRIMARY KEY (`id`),
  ADD KEY `main_shared_sharedUser_id_da7e3710_fk_main_user_id` (`sharedUser_id`),
  ADD KEY `main_shared_user_id_f7a33115_fk_main_user_id` (`user_id`);
...
--   ADD PRIMARY KEY (`id`),
--   ADD KEY `app_verification_user_id_82713bde_fk_main_user_id` (`user_id`);
...
--
-- AUTO_INCREMENT for table `main_files`
--
ALTER TABLE `main_files`
...
--
-- AUTO_INCREMENT for table `main_shared`
--
ALTER TABLE `main_shared`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
-- Constraints for table `main_files`
--
ALTER TABLE `main_files`
  ADD CONSTRAINT `FK_folder` FOREIGN KEY (`folder_id`) REFERENCES `main_folder` (`id`),
  ADD CONSTRAINT `main_files_user_id_fbc7dfc0_fk_main_user_id` FOREIGN KEY (`user_id`) REFERENCES `main_user` (`id`);

--
-- Constraints for table `main_shared`
--
ALTER TABLE `main_shared`
  ADD CONSTRAINT `main_shared_sharedUser_id_da7e3710_fk_main_user_id` FOREIGN KEY (`sharedUser_id`) REFERENCES `main_user` (`id`),
  ADD CONSTRAINT `main_shared_user_id_f7a33115_fk_main_user_id` FOREIGN KEY (`user_id`) REFERENCES `main_user` (`id`);

--
-- Constraints for table `app_verification`
-- --
-- ALTER TABLE `app_verification`
--   ADD CONSTRAINT `app_verification_user_id_82713bde_fk_main_user_id` FOREIGN KEY (`user_id`) REFERENCES `main_user` (`id`);
